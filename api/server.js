...
let requestInProgress = false; // Rate limiting flag
...
`;
        ...
        }, 60000); // Release the lock after 1 minute (adjust as needed)
    }
}

// Fetch and post crypto prices (using setInterval with rate limiting)
setInterval(fetchAndPostPrices, 60000); // Check every minute, but rate limiting prevents excessive requests
